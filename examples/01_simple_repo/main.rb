...
event_repository   = EventSourced::Repository.new(store: EventSourced::EventStores::MemoryEventStore.new)
command_repository = EventSourced::Repository.new(store: EventSourced::EventStores::MemoryEventStore.new)
